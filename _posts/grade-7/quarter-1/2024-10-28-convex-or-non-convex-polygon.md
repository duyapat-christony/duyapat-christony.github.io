---
title: 1.2a Convex or Non-Convex Polygon
...
<div class="loader">
  <iframe src="/assets/lumi/review_name_the_polygon.html" width="100%" ></iframe>
...
- **Convex Polygons**
  - [x] A convex polygon is a polygon where all interior angles are less than 180 degrees.
  - [x] No vertices point inward
  - [x] A line segment drawn between any two points in the polygon will always lie inside or on the boundary of the polygon.
  - [x] All diagonals are inside the polygon.
- **Non-Convex Polygons**
  - [x] A non-convex or concave polygon is a polygon that has at least one interior angle greater than 180 degrees. 
  - [x] Has at least one vertex that points inward. 
  - [x] A line segment drawn between some points within the polygon may pass outside it.
  - [x] They are also called as **concave polygons**.

### Examples

![Convex Polygons](/assets/img/math/convex_polygons.webp)
...
![Non-Convex Polygons](/assets/img/math/non_convex_polygons.webp)
...
<div style="position: relative; width: 100%; height: 0; padding-bottom: 62.5%; margin-bottom: 20px;">
  <iframe scrolling="no" title="Convex or Non-Convex Polygons" 
    src="https://www.geogebra.org/material/iframe/id/amywrftk/width/800/height/500/border/888888/sfsb/true/smb/false/stb/false/stbh/false/ai/false/asb/false/sri/true/rc/false/ld/false/sdz/false/ctl/false" 
